module.exports = {
    ...
    rules: {
      ...
      'jsx-quotes': [2, 'prefer-single'], // JSX元素中的字符串必须使用双引号
      quotes: [2, 'single'], // 字符串必须使用单引号
      'key-spacing': [2, { afterColon: true }], // 限定变量赋值时冒号后需要跟空格
      'import/order': 2, // 引入按照一定顺序
      'import/no-default-export': 0, // 允许defalut export
      ...
      '@typescript-eslint/naming-convention': [
        2,
        { selector: ['variable', 'function'], modifiers: ['const', 'global'], format: ['UPPER_CASE', 'camelCase', 'PascalCase'] },
      ],
      'promise/catch-or-return': 1,
      // =========================
      // React规则
      // =========================
      'react/jsx-indent-props': [2, 2], // JSX Props缩进
    ...
    overrides: [
      ...
      },
      {
        ...
        rules: {
          ...
          '@typescript-eslint/naming-convention': [
            2,
            { selector: ['function'], modifiers: ['const'], format: ['camelCase', 'PascalCase'] },
          ],
        },
      },
    ],
